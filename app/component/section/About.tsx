...
//           +
//         </span>
//         <motion.span className="text-6xl sm:text-8xl md:text-[9rem] font-medium tracking-tight leading-none">
//           {rounded}
//         </motion.span>
//       </div>
//       <p className="mt-2 sm:mt-4 text-xs sm:text-sm md:text-base text-gray-500 font-medium tracking-wide text-center max-w-xs">
//         {label}
//       </p>
//     </div>
//   );
...
//   return (
//     <section className="bg-white py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-6 overflow-hidden">
//       <div className="max-w-6xl mx-auto flex flex-col items-center text-center">

//         <h2
//           ref={headingRef}
//           className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-inter-tight font-medium text-[#111] max-w-7xl leading-snug sm:leading-snug md:leading-tight lg:leading-tight tracking-tight"
//         >
...
//         {/* Counters */}
//         <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 mt-10 sm:mt-12 md:mt-16 w-full">
